...
export const GroupDetailsView = ({ group, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-2xl border border-gray-200/80 shadow-[0_16px_48px_rgba(0,0,0,0.14)] w-full max-w-2xl mx-4 max-h-[90vh] flex flex-col"
            ...
            <div className="p-6 space-y-5">
              ...
              <div className="rounded-xl border border-gray-200/80 overflow-hidden">
                <div className="px-5 py-3 border-b border-gray-100">
                  ...
                  <p className="text-[12px] text-gray-400 mt-0.5">Click a month to view member payment details</p>
                </div>
